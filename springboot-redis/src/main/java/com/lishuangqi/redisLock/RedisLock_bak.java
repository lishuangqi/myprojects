...
// */
//public class RedisLock_bak {
//
//    private static final Logger LOGGER = LoggerFactory.getLogger(RedisLock_bak.class);
//
...
//     */
//    public RedisLock_bak(RedisTemplate redisTemplate, String lockKey) {
...
//     */
//    public RedisLock_bak(RedisTemplate redisTemplate, String lockKey, int expireTime) {
...
//     */
//    public RedisLock_bak(RedisTemplate redisTemplate, String lockKey, long timeout) {
//        this(redisTemplate, lockKey);
//        this.timeout = timeout;
//    }
//
...
//     * @param timeout       请求锁的超时时间(单位：毫秒)
//     */
//    public RedisLock_bak(RedisTemplate redisTemplate, String lockKey, int expireTime, long timeout) {
