...
* @date 2018年1月9日
 */
public class KafkaProducerTest3 implements Runnable {
...
//    private final String servers="192.169.2.156:9092,192.169.2.98:9092,192.169.2.188:9092";
	 ...
	 * @param
	 */
	public KafkaProducerTest3(String topicName) {
...
//				Utils.sleep(1);
	...
	public static void main(String args[]) {
		KafkaProducerTest3 test = new KafkaProducerTest3("1002_INSERT");
		KafkaProducerTest3 test1 = new KafkaProducerTest3("1005_INSERT");
		KafkaProducerTest3 test2 = new KafkaProducerTest3("1001_INSERT");
		KafkaProducerTest3 testd = new KafkaProducerTest3("TEST_INSERT1");
