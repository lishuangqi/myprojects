package com.shuangqi.kafkaTest.test2;
...
* @date 2018年1月26日
 */
public class KafkaConsumerTest2 implements Runnable {
...
//		topic各分区都存在已提交的offset时，从offset后开始消费；只要有一个分区不存在已提交的offset，则抛出异常
	...
	public KafkaConsumerTest2(String topicName) {
	...
	public static void main(String args[]) {
		KafkaConsumerTest2 test1 = new KafkaConsumerTest2("KAFKA_TEST");
